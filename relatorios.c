...
char telaRealtorio3(void) {
	...
	printf("///            ||||||||||||||||||||||||||||||||||||||||||||               ///\n");
	printf("///                                                                       ///\n");
	printf("///                  Proposta de Reatorio numero 3:                       ///\n");
	printf("///                                                                       ///\n");
	printf("///           lista de cheques recebidos de uma empresa ou de um          ///\n");
	printf("///           cliente a partir do nome do numero da conta do mesmo(a).    ///\n");
	printf("///                                                                       ///\n");
	printf("///                                                                       ///\n");
	printf("///                                                                       ///\n");
	printf("///                                                                       ///\n");
